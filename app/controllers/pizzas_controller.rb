class PizzasController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @pizza.update(pizza_params)
        format.html { redirect_to @pizza, notice: "Pizza atualizada com sucesso!", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to pizzas_path, notice: "Pizza apagada com sucesso!", status: :see_other }
