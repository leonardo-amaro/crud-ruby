class PizzasController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @pizza.update(pizza_params)
        format.html { redirect_to @pizza, notice: "Pizza was successfully updated", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to pizzas_path, notice: "Pizza was successfully destroyed", status: :see_other }
  ...
  private
    ...
    def pizza_params
      params.expect(pizza: [ :nome, :preco ])
    end
end
